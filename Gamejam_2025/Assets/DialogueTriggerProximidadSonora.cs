...
public class DialogueTriggerProximidadSonora: MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            seHaActivado = true;
            if (!PuzzleManager.proximidadSonoraDialogueDoned)
            {
                PuzzleManager.proximidadSonoraDialogueDoned = true;
