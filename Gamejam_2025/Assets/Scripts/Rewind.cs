...
public class Rewind : MonoBehaviour
{
    ...
    // Variables para el rebote de la distorsi�n de lente
    ...
    private float lensDistortionMaxValue = 0.5f; // Tama�o m�ximo de la distorsi�n (ajusta seg�n necesites)
    private int reboundCount = 0;  // N�mero de repeticiones del rebote
    private int maxRebounds = 4;   // M�ximo n�mero de repeticiones
    private float reboundIntensityDecay = 0.5f;  // Factor para reducir la intensidad despu�s de cada rebote
    ...
    void Start()
    {
        ...
        StartLensDistortionRebound(); // Inicia el rebote de la distorsi�n de lente al inicio
    }
    ...
    void Update()
    {
        ...
        {
            // Inicia el rebote de la distorsi�n de lente al final del rewind
            StartLensDistortionRebound();
        }

        // Maneja la animaci�n de rebote de la distorsi�n de lente
    ...
    // Rewinds el estado del jugador (movimiento y rotaci�n)
    private void RewindPlayerState()
    {
        ...
        // Si no quedan m�s estados que retroceder, para el rewind
    ...
    // Temporizador de cuenta regresiva para activar el rewind despu�s de que pase el tiempo
    ...
    // Aplica el efecto de aberraci�n crom�tica
    ...
    // Aplica el efecto de grano de pel�cula
    ...
    // Aplica el efecto de distorsi�n de lente
    ...
    // Aplica ajustes de color (tono y saturaci�n)
    ...
    // Resetea el blur cuando deshabilitamos el componente o cerramos la aplicaci�n
    ...
    // Inicia el rebote de la distorsi�n de lente al principio
    ...
    // Maneja el rebote de la distorsi�n de lente (expansi�n y contracci�n) con intensidad decreciente
    private void HandleLensDistortionRebound()
    {
        if (reboundCount < maxRebounds)
        {
            ...
            {
                // Rebotar la distorsi�n de lente con una onda (expansi�n y contracci�n)
        ...
        {
            // Al finalizar los rebotes, restablece la distorsi�n de lente a su valor inicial
